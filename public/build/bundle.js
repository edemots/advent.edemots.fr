...
var app = (function () {
    ...
    */
    ...
    const firebaseConfig = {
      apiKey: {"env":{"FIREBASE_API_KEY":"AIzaSyCh38BKuI6uFCeYhO5Mhp0YDvAYBBYTk2M","FIREBASE_AUTH_DOMAIN":"advent-198b3.firebaseapp.com","FIREBASE_PROJECT_ID":"advent-198b3"}}.env.FIREBASE_API_KEY,
      authDomain: {"env":{"FIREBASE_API_KEY":"AIzaSyCh38BKuI6uFCeYhO5Mhp0YDvAYBBYTk2M","FIREBASE_AUTH_DOMAIN":"advent-198b3.firebaseapp.com","FIREBASE_PROJECT_ID":"advent-198b3"}}.env.FIREBASE_AUTH_DOMAIN,
      projectId: {"env":{"FIREBASE_API_KEY":"AIzaSyCh38BKuI6uFCeYhO5Mhp0YDvAYBBYTk2M","FIREBASE_AUTH_DOMAIN":"advent-198b3.firebaseapp.com","FIREBASE_PROJECT_ID":"advent-198b3"}}.env.FIREBASE_PROJECT_ID,
    };

    firebase$1.initializeApp(firebaseConfig);

    const auth = firebase$1.auth();
    const googleAuthProvider = new firebase$1.auth.GoogleAuthProvider();

    /* src/AuthProvider.svelte generated by Svelte v3.29.7 */
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("AuthProvider", slots, ['default']);
    	const loginWithGoogle = () => auth.signInWithPopup(googleAuthProvider);
    	const logout = () => auth.signOut();
    	setContext("auth", { loginWithGoogle, logout });
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<AuthProvider> was created with unknown prop '${key}'`);
    	});
    ...
    class AuthProvider extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src/Login.svelte generated by Svelte v3.29.7 */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(figure, div10);
    			append_dev(div10, img1);
    			/*img1_binding*/ ctx[3](img1);

    			if (!mounted) {
    				dispose = listen_dev(button, "click", prevent_default(/*loginWithGoogle*/ ctx[1]), false, true, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    		...
    		d: function destroy(detaching) {
    			...
    			/*img0_binding*/ ctx[2](null);
    			/*img1_binding*/ ctx[3](null);
    			mounted = false;
    			dispose();
    		}
    	};
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	return [images, loginWithGoogle, img0_binding, img1_binding];
    }
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "type", "button");
    			attr_dev(button, "class", "svelte-1p68y10");
    			add_location(button, file$1, 7, 2, 107);
    			attr_dev(nav, "class", "svelte-1p68y10");
    			add_location(nav, file$1, 6, 0, 99);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", prevent_default(/*logout*/ ctx[0]), false, true, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ getContext, logout });
    	return [logout];
    }
    ...
    /* src/Calendar.svelte generated by Svelte v3.29.7 */
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = space();
    			article = element("article");
    			article.textContent = "1er décembre";
    			add_location(article, file$2, 6, 2, 86);
    			attr_dev(section, "class", "svelte-1chpq7j");
    			add_location(section, file$2, 4, 0, 64);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(animate0, file$3, 8, 6, 204);
    			...
    			add_location(animate1, file$3, 17, 6, 434);
    			attr_dev(circle0, "cx", "22");
    			attr_dev(circle0, "cy", "22");
    			attr_dev(circle0, "r", "1");
    			add_location(circle0, file$3, 7, 4, 167);
    			...
    			add_location(animate2, file$3, 28, 6, 724);
    			...
    			add_location(animate3, file$3, 37, 6, 957);
    			attr_dev(circle1, "cx", "22");
    			attr_dev(circle1, "cy", "22");
    			attr_dev(circle1, "r", "1");
    			add_location(circle1, file$3, 27, 4, 687);
    			attr_dev(g, "fill", "none");
    			attr_dev(g, "fill-rule", "evenodd");
    			attr_dev(g, "stroke-width", "2");
    			add_location(g, file$3, 6, 2, 110);
    			attr_dev(svg, "width", "44");
    			attr_dev(svg, "height", "44");
    			attr_dev(svg, "viewBox", "0 0 44 44");
    ...
    /* src/Loading.svelte generated by Svelte v3.29.7 */
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(section, "class", "svelte-1s1jxw9");
    			add_location(section, file$4, 4, 0, 70);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, section, anchor);
    			mount_component(loader, section, null);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    ...
    const authenticating = derived(user, $user => $user === undefined);
    const authenticated = derived(user, $user => $user !== null);
    ...
    function create_default_slot(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*$authenticating*/ ctx[0]) return 0;
    		if (/*$authenticated*/ ctx[1]) return 1;
    		return 2;
    	}
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			main = element("main");
    			create_component(authprovider.$$.fragment);
    			attr_dev(main, "class", "svelte-1pdccis");
    			add_location(main, file$5, 11, 0, 311);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(authprovider, main, null);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    			const authprovider_changes = {};

    			if (dirty & /*$$scope, $authenticating, $authenticated*/ 7) {
    				authprovider_changes.$$scope = { dirty, ctx };
    			}

    			authprovider.$set(authprovider_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(tailwind.$$.fragment, local);
    			transition_in(authprovider.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(tailwind.$$.fragment, local);
    			transition_out(authprovider.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			...
    			destroy_component(authprovider);
    		}
    	};
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	let $authenticating;
    	let $authenticated;
    	validate_store(authenticating, "authenticating");
    	component_subscribe($$self, authenticating, $$value => $$invalidate(0, $authenticating = $$value));
